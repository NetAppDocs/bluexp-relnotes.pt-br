...
+
Administrar a integridade, a governança e a descoberta do armazenamento para os recursos de armazenamento na organização. Esta função também pode realizar atualizações de software nos recursos de armazenamento.
