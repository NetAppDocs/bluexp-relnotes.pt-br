...
https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-managing-svms-azure.html["Crie VMs de storage de fornecimento de dados para o Cloud Volumes ONTAP no Azure"^]
